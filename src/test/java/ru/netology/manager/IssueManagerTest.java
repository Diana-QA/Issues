...
class IssueManagerTest {
    ...
    private final Issue issue2 = new Issue(2, "Pavle", Set.of("Jupiter"), Set.of("Sasha"), true, sdf.parse("2020-07-06"));
    ...
    private final Issue issue5 = new Issue(5, "Bob", Set.of("Vintage"), Set.of("Mari"), false, sdf.parse("2019-01-15"));
